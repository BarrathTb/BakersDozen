      ...
      <v-card-text>
        ...
        >
          ...
          <template v-slot:[`item.actions`]="{ item }">
            <v-btn icon small color="primary" :to="`/recipes/${item.id}`" title="View Details">
              <v-icon>mdi-eye</v-icon>
            </v-btn>
            <v-btn icon small color="secondary" @click="startBake(item)" title="Start Bake">
