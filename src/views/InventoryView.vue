<template>
  <div>
    ...
    <v-row class="mb-4">
      <v-col cols="12" md="4">
        <v-btn block color="primary" to="/deliveries/new" height="50">
      ...
      <v-col cols="12" md="4">
        <v-btn block color="secondary" to="/removals/new" height="50">
      ...
      <v-col cols="12" md="4">
        <v-btn block color="accent" to="/bakes/new" height="50">
...
export default defineComponent({
  ...
  setup() {
    ...
    const outOfStockCount = computed(
      () => ingredients.value.filter((item) => item.current_quantity <= 0).length,
    )
    ...
    const setupSubscription = () => {
      unsubscribe = db.subscribe((table, _action /* unused */, _item /* unused */) => {
