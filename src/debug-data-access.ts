...
// // Run the tests if this file is executed directly, but only if user is logged in
...
//         })
//     } else {
//       console.log('User not logged in. Please log in before running data access tests.')
//     }
//   })
// }
